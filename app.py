...
# import chart_studio.plotly as cl  # Eliminar si no es necesario
...
home1 = 'C:/Users/kathy/Desktop/ml/app/assets/home1.png'
        ...
        [
            dbc.Row(
                [
                    dbc.Col(
                        [
                            html.I(className='bi bi-houses', style={'font-size': '30px'}),
                            dbc.NavbarBrand('REAL ESTATE AGENCY DIGOTA', className='ms-2', style={'font-size':'18px'})
                        ],
                        width={'size': 'auto'}
                    )
                ],
                ...
                [
                    dbc.Col(
                        [
                            dbc.Nav(
                                [
                                    dbc.NavItem(dbc.NavLink("HOME", href="/"), style={'font-size': '18px'}),
                                    dbc.NavItem(dbc.NavLink("BOOK NOW", href="/book_now"), style={'font-size': '18px'}),
                                ],
                                navbar=True
                            )
                        ],
                            ...
                            dbc.Collapse(
                                dbc.Nav(
                                    [
                                        dbc.NavItem(
                                            dbc.NavLink(
                                                html.I(className='bi bi-github', style={'font-size': '25px'}),
                                        ...
                                        dbc.NavItem(
                                            dbc.NavLink(
                                                html.I(className='bi bi-database-down', style={'font-size': '25px'}),
